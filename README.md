...
| `risk_level_10h` | 10시 RS를 4단계로 분류한 위험등급입니다. 일반(0\~17) / 주의(17\~25) / 위험(25\~35) / 고위험(35\~100). 경계값은 vehicle 포함 RS 분포의 중앙값(\~18), 75th percentile(\~23), 90th percentile(\~31)을 참고하여 라운드된 정수값으로 설정하였습니다. |
